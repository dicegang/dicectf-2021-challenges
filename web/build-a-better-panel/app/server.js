...
const admin_key = 'repwn_supersecret_j5UYReZuM6xEDSpJT3G6'; // TODO remove in given source
const secret_token = 'redpwn_supersecret_dLnPgvOreJdokktZuZ8v'; 
...
db.run(query, [], (err) => {
    if(!err){
        let innerQuery = `INSERT INTO flag SELECT 'dice{un1n73nd3d_54d_1n73nd3d_h4ppy}'`;
        db.run(innerQuery);
    }else{
