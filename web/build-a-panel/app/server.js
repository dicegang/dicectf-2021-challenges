...
const admin_key = 'repwn_supersecret_1cFHu69rET1tceXf0gW5'; // TODO remove in given source
const secret_token = 'redpwn_supersecret_G9nNtlRQKX65WZUn2nV6'; 
...
db.run(query, [], (err) => {
    if(!err){
        let innerQuery = `INSERT INTO flag SELECT 'dice{ch41n_ChAIn_aNd_m0Re_cHaIn}'`;
        db.run(innerQuery);
    }else{
